...
SECRET_KEY = '!b@#4q7u5=inbo=6_^0#505r9!77et9$%643a*ihr+nv$6j$w$'
...
ROOT_URLCONF = 'simple_todo.config.urls'
...
WSGI_APPLICATION = 'simple_todo.config.wsgi.application'
